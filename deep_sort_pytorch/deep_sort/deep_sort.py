...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, ori_img, wander):
        ...
        for track in self.tracker.tracks:
            ...
            # track_id가 존재하고 wander 리스트에 track_id가 없으면 추가
            # wander 에 track_id가 없을 경우
            ...
            '''if not wander.get(track.track_id):
                wander[track.track_id][1] += 5
                print(f'/////////////////////////////{wander[track.track_id][1]}')
            if wander[track.track_id][1] >= 500 :
                del wander[track.track_id]'''
