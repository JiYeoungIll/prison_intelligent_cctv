...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, ori_img, wander, fw_queue, fight_time):
        ...
        for track in self.tracker.tracks:
            ...
            # wander 에 track_id가 있을 경우
                ...
                if stime - wander[track.track_id][0] >= sec:
                    ...
                    #x11, y11, x22, y22 = [int(i) for i in bbox]
                    cv2.putText(ori_img, wander_text, (x11, y11 - 5), cv2.FONT_HERSHEY_PLAIN, textsize, [76, 1, 43], 2)
                else :
